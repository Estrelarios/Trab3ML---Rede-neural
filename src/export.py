"""
Push a trained SAC agent to the Hugging Face Hub.
"""
...
def push_to_hub(
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        torch.save(agent.actor.state_dict(), local_directory / "model.pt")
        ...
        model_card = f"""
# Soft Actor-Critic (SAC) Agent playing {env_name}

This is a trained Soft Actor-Critic (SAC) agent for the MuJoCo {env_name} environment.

## Model Details

The model was trained using the code available [here](https://github.com/giansimone/sac-mujoco-humanoid/).
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Push a trained SAC agent to Hugging Face Hub.")
    parser.add_argument(
        "--username",
        "-u",
        type=str,
